...
public class Ward
{
    ...
    {
        String result = "\ncontainers.Ward " + name + " with capacity " + beds.length
    ...
    public static void main(String[] args)
    {
        ...
        // testing all the methods with one instance of a containers.Ward
        ...
        String expected = "\ncontainers.Ward surgery with capacity 11 has the following patients: \n" +
                "bed 200: \n" +
                "bed 201: \n" +
                "bed 202: \n" +
                "bed 203: \n" +
        ...
        expected = "\ncontainers.Ward ER with capacity 3 has the following patients: \n" +
                "bed 1: Dan\n" +
                "bed 2: \n" +
                "bed 3: \n";
        if(!w.toString().equals(expected)) {
